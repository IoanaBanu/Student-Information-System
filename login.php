...
if (isset($_POST['btnlogin'])) {
    ...
    if ($uname == '') {
?>    <script type="text/javascript">
                alert("Nume de utilizator sau parolă greșit/ă!");
                </script>
            <?php
...
?>    <script type="text/javascript">
                alert("Nume de utilizator neîmregistrat. Vă rugăm să contactați administratorul!");
                window.location = "index.php";
                </script>
        <?php
        }
...
<html lang="en">
  ...
  <head>
    <title>Informații stdenți</title>
    <meta charset="utf-8">
...
<div class="logo">
	<img src="logo.png">
	  ...
	  <button onclick="document.location='/admin/login.php'">Admin Login</button>
        <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 pr-md-5 mr-auto">
			...
			<p>Loghează-te cu ID-ul tău personal pentru a îți vizualiza datele și calificativele primite. </p>
          </div>
          <div class="col-md-6">
            <div class="quick-contact-form bg-white">
                ...
                <form action="login.php" method="POST">
                  <div class="form-group">
                    <input type="number" class="form-control" name="uname" placeholder="Număr ID">
                  </div>
